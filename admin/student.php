...
<div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;">Total Students : <span class="text-primary"><?php echo $users; ?></span></p>
    </div>
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td style="cursor:pointer;" data-toggle="modal" data-target="#exampleModalCenter" data-role="view" data-id="<?php echo $row['email'];?>"><?php echo $row['phone']; ?></td>
