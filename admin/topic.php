...
<body>
    <div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;">Topics</p>
    </div>
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td><button class="btn btn-danger" style="margin: 0;" data-role="delete" data-id="<?php echo $row['id'];?>">Delete</button></td>
                            </tr>
                <?php
                        }
                    }
